...
export const bookingFormSchema = z.object({
  vehicleId: z.number({ message: "Vui lòng nhập xe hợp lệ." }).min(1, { message: "Vui lòng nhập xe hợp lệ." }),
  parkingSlotId: z.number({ message: "Vui lòng nhập vị trí đỗ hợp lệ." }).min(1, { message: "Vui lòng nhập vị trí đỗ hợp lệ." }),
